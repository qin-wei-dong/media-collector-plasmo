...
const styles: Record<string, React.CSSProperties> = {
  ...
  sub: { fontSize: 13, color: theme.textTertiary, marginBottom: 24, lineHeight: 1.5 },
...
const stylesLocal: Record<string, React.CSSProperties> = {
  ...
  stepTitle: { fontSize: 14, fontWeight: 600, marginBottom: 1 },
  stepDesc: { fontSize: 12, color: theme.textTertiary, lineHeight: 1.4 },
  stepBadge: { fontSize: 11, fontWeight: 700, color: "rgba(255,255,255,0.35)" },
}
